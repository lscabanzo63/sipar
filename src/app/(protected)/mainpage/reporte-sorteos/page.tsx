...
export default function ReporteDeSorteosPage() {
  // (Opcional) estados locales solo para demo visual; puedes quitarlos si no quieres interactividad
  ...
  >
    ...
    Buscar
      ...
      {/* (Opcional) Contenedor de resultados en blanco, puro esqueleto visual */}
