...
export default function InitialConfigurationPage() {
  ...
  return (
    <main className="h-dvh flex flex-col lg:flex-row">
      {/* Columna izquierda: flujo normal, scroll si hace falta */}
      <section className="flex-1 h-dvh bg-[var(--color-header)] flex flex-col px-6 lg:px-12 py-10 overflow-auto">
        <div className="w-full max-w-3xl mx-auto flex flex-col gap-8">
          ...
          >
            <header>
              ...
              <p className="mt-1 text-sm text-neutral-600">
                Por favor, asegúrate de que la información de abajo es correcta.
                Si necesitas cambiar algo, presiona{" "}
                <button
                  type="button"
            ...
            {/* Campos (con overlay para bloquear interacción) */}
            ...
            {/* Espacio reservado para evitar saltos al mostrar "Guardar cambios" */}
          ...
          {/* Botón Confirmar EN FLUJO, centrado y con margen inferior */}
      ...
      {/* Columna derecha con imagen y overlay 65% */}
